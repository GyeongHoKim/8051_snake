...
_set_snake: 
	MOV R0, #SNAKE_LENGTH_PTR
	MOV A, @R0
	MOV R3, A; snake length in r3

	MOV R0, #SNAKE_TAIL; snake tail in r0
	next_byte:
	MOV A, @R0; snake tail position in acc
	INC R0; next snake in r0
	PUSH REG_0
	PUSH REG_3
...
; Arguments: A (snake tail position)
